...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        countryCasesTV = findViewById(R.id.idTVNationalCases)
        countryRecoveredTV = findViewById(R.id.idTVNationalRecovered)
        countryDeathsTV = findViewById(R.id.idTVNationalDeaths)
